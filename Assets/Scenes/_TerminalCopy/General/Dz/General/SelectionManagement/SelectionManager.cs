...
namespace Dz.SelectionManagement {
    public partial class SelectionManager : MonoBehaviour {
        ...
        [DisableIf(nameof(multipleSelection))]
        [SerializeField] bool selectAgainToConfirmInSingleSelection = false;
        ...
        public void Select(int index) {
            ...
            if (multipleSelection) {
                ...
                if (selection.IsSelected && selectAgainToConfirmInSingleSelection) {
                    selection.Confirm();
                }
                else {
                    selection.Select();
